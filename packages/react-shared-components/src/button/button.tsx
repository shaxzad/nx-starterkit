...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseClasses =
      'inline-flex items-center justify-center gap-2 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ';
